      ...
      {showModal && (
        <div
          ...
          <div
            ...
            <p style={{ color: 'var(--gold)', fontSize: 12, letterSpacing: 2, textTransform: 'uppercase', marginBottom: 4 }}>Share</p>
            <p style={{ color: 'var(--text-muted)', fontSize: 13, marginBottom: 20 }}>Share AstroPillar with friends ✨</p>
